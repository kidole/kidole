...
/**
 * REST controller for managing {@link com.domain.Team}.
 */
@RestController
@RequestMapping("/api")
public class TeamResource {
     ...
     */
    @GetMapping("/teams")
    public List<TeamDTO> getAllTeams(@RequestParam(required = false) String filter) {
        if ("score-is-null".equals(filter)) {
            log.debug("REST request to get all Teams where score is null");
            return teamService.findAllWhereScoreIsNull();
        }
