...
export class ConfrontationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.confrontationService
        ...
        .subscribe(
          (res: HttpResponse<IConfrontation[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInConfrontations(): void {
    this.eventSubscriber = this.eventManager.subscribe('confrontationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IConfrontation[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    this.router.navigate(['/confrontation'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
