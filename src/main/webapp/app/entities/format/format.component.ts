...
export class FormatComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.formatService
        ...
        .subscribe(
          (res: HttpResponse<IFormat[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInFormats(): void {
    this.eventSubscriber = this.eventManager.subscribe('formatListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFormat[] | null, headers: HttpHeaders, page: number): void {
