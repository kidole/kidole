...
export class CompetitionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.competitionService
        ...
        .subscribe(
          (res: HttpResponse<ICompetition[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: ICompetition[] | null, headers: HttpHeaders, page: number): void {
