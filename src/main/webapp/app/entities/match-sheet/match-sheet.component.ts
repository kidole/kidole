...
export class MatchSheetComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.matchSheetService
        ...
        .subscribe(
          (res: HttpResponse<IMatchSheet[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInMatchSheets(): void {
    this.eventSubscriber = this.eventManager.subscribe('matchSheetListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMatchSheet[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    this.router.navigate(['/match-sheet'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
