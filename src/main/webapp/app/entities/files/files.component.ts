...
export class FilesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.filesService
        ...
        .subscribe(
          (res: HttpResponse<IFiles[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInFiles(): void {
    this.eventSubscriber = this.eventManager.subscribe('filesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFiles[] | null, headers: HttpHeaders, page: number): void {
