...
export class DelegationMembersService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/delegation-members';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDelegationMembers[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
