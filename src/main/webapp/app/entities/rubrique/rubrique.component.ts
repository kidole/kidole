...
export class RubriqueComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.rubriqueService
        ...
        .subscribe(
          (res: HttpResponse<IRubrique[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInRubriques(): void {
    this.eventSubscriber = this.eventManager.subscribe('rubriqueListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IRubrique[] | null, headers: HttpHeaders, page: number): void {
