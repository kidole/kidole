...
export class AccreditationStepComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.accreditationStepService
        ...
        .subscribe(
          (res: HttpResponse<IAccreditationStep[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInAccreditationSteps(): void {
    this.eventSubscriber = this.eventManager.subscribe('accreditationStepListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAccreditationStep[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    this.router.navigate(['/accreditation-step'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
    ...
    this.accreditationSteps = data ? data : [];
  }
