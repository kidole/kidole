...
export class AccreditationService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/accreditations';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IAccreditation[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
