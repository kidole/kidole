...
export class PrestationServiceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.prestationServiceService
        ...
        .subscribe(
          (res: HttpResponse<IPrestationService[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInPrestationServices(): void {
    this.eventSubscriber = this.eventManager.subscribe('prestationServiceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPrestationService[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    this.router.navigate(['/prestation-service'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
    ...
    this.prestationServices = data ? data : [];
  }
