...
export class PrestationServiceService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/prestation-services';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPrestationService[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
