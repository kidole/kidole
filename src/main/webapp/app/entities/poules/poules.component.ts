...
export class PoulesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.poulesService
        ...
        .subscribe(
          (res: HttpResponse<IPoules[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInPoules(): void {
    this.eventSubscriber = this.eventManager.subscribe('poulesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPoules[] | null, headers: HttpHeaders, page: number): void {
