...
export class DisciplineComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.disciplineService
        ...
        .subscribe(
          (res: HttpResponse<IDiscipline[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInDisciplines(): void {
    this.eventSubscriber = this.eventManager.subscribe('disciplineListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDiscipline[] | null, headers: HttpHeaders, page: number): void {
