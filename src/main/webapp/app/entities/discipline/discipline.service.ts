...
export class DisciplineService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/disciplines';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDiscipline[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
