...
describe('Service Tests', () => {
  describe('Accreditation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Accreditation(0, AccreditationList.ATHLETE, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', AccreditationState.ACTIVE, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Accreditation', () => {
        const returnedFromService = Object.assign(
          {
            accreditationName: 'BBBBBB',
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
            accreditationEmail: 'BBBBBB',
            accreditationStatus: 'BBBBBB',
            accreditationDetail: 'BBBBBB'
          },
          elemDefault
        );
