...
describe('Service Tests', () => {
  describe('AccreditationStep Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new AccreditationStep(0, currentDate, currentDate, 0, AccreditationList.ATHLETE, false, false, 'AAAAAAA');
    });
        ...
        const returnedFromService = Object.assign(
          {
            startTime: currentDate.format(DATE_TIME_FORMAT),
            endTime: currentDate.format(DATE_TIME_FORMAT),
            accreditationStepnumber: 1,
            accreditationType: 'BBBBBB',
            isPublic: true,
            uri: true,
            fields: 'BBBBBB'
          },
