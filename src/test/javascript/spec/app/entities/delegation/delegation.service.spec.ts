...
describe('Service Tests', () => {
  describe('Delegation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Delegation(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Delegation', () => {
        const returnedFromService = Object.assign(
          {
            delegationName: 'BBBBBB',
            delegationCountry: 'BBBBBB',
            delegationLocality: 'BBBBBB',
            delegationCode: 'BBBBBB'
          },
          elemDefault
        );
