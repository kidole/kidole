...
public class RubriqueResourceIT {
    ...
    public void createRubrique() throws Exception {
        ...
        assertThat(testRubrique.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testRubrique.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testRubrique.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testRubrique.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    }
    ...
    public void updateRubrique() throws Exception {
        ...
        Rubrique testRubrique = rubriqueList.get(rubriqueList.size() - 1);
        assertThat(testRubrique.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testRubrique.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testRubrique.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testRubrique.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
    }
